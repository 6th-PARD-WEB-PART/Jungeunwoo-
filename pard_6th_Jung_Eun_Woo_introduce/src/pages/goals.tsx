...
//             이번 학기 <span className="text-blue-800/90">목표</span>
//           </h1>
//           <p className="mt-3 text-slate-700">학업, 학교 생활, 그리고 PARD 활동으로 나누어 보았습니다.</p>
//         </section>

//         {/* 목표 카드 3개 */}
//         <section className="grid md:grid-cols-3 gap-6">
//           {/* 학업 관련 */}
//           <div className="rounded-2xl bg-white/80 p-6 shadow hover:shadow-lg transition">
//             <h2 className="text-xl font-bold mb-3">학업 관련</h2>
...
//           {/* 학교 생활 */}
//           <div className="rounded-2xl bg-white/80 p-6 shadow hover:shadow-lg transition">
//             <h2 className="text-xl font-bold mb-3">학교 생활</h2>
//             <ul className="space-y-2 text-slate-800">
...
//           {/* PARD 활동 */}
//           <div className="rounded-2xl bg-white/80 p-6 shadow hover:shadow-lg transition">
//             <h2 className="text-xl font-bold mb-3">PARD 관련</h2>
//             <ul className="space-y-2 text-slate-800">
//               <li>· 프론트 엔드 마스터</li>
